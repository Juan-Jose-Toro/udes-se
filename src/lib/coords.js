...
//   of element
export const getCoordsElement = (element) => ({
  x: element.offsetLeft + element.offsetWidth / 2,
  y: element.offsetTop + element.offsetHeight / 2,
});

// getCoordsOfChildren(element) accepts a ref of an html element and returns and
...
export const toLineObjectFormat = (obj1, obj2) => {
  return {x1: obj1.x, y1: obj1.y, x2: obj2.x, y2: obj2.y};
}
